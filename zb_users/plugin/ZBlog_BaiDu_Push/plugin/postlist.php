	...
	?> 
        <aside class="main-sidebar">
            <section class="sidebar">
                <ul class="sidebar-menu" data-widget="tree">
                    <li class="header"></li>
                    <?php ZBlog_BaiDu_Push_SubMenu(2);?>
                </ul>
            </section>
        </aside>
        <div class="content-wrapper">
            ...
            <div class="content-body">
                <div class="container-fluid">
					<div class="panel">
                        <div class="panel-heading">
                            <div class="panel-title">未推送列表</div>
                        </div>
                        <div class="panel-body">
						<form method="get" action="post.php">
							<?php 
							$p=new Pagebar($zbp->host.'zb_users/plugin/ZBlog_BaiDu_Push/plugin/postlist.php?act=list{&page=%page%}',false);      		 		 
							$p->PageCount='50';       	  		
					...
					<?php 
						foreach ($array as $key => $artcle) {
							$str .='<tr>
								...
								<td><span class="label label-warning">未推送</span></td>
								<td><a href="post.php?type=pushid&id='.$artcle->ID.'" class="btn btn-xs btn-success">手动推送</a></td>
				...
				echo '<input class="btn btn-sm btn-primary" type="submit" onclick="return window.confirm(\'单击“确定”继续。单击“取消”停止。\');" value="手动推送所选项目"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';     	     	
				echo '</p>';      	   	 
				if ($p->buttons){      		  		
					echo '<ul class="pager">';       			  
