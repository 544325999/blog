...
<article class="item-body item-mode<?php if ($zbp->Config('downlee')->gdtxoff=='1') { ?> wow fadeInDown<?php } ?>" id="post-<?php  echo $i;  ?>">
	...
	<div class="item-wrapper">
		...
		<div class="item-footer">
			<a href="<?php  echo $article->Url;  ?>"<?php if ($zbp->Config('downlee')->blankoff=='1') { ?> target="_blank"<?php } ?>>
				...
				<span class="item-font-eye"><i class="icon font-eye"></i><?php  echo $article->ViewNums;  ?></span>
