...
<article class="item-body auto-list<?php if ($zbp->Config('downlee')->gdtxoff=='1') { ?> wow fadeInDown<?php } ?>" id="post-<?php  echo $i;  ?>">
	...
	<div class="item-wrapper">
		...
		<header class="item-header">
			<h2 class="item-title"><a href="<?php  echo $article->Url;  ?>" title="<?php  echo $article->Title;  ?>" rel="bookmark"<?php if ($zbp->Config('downlee')->blankoff=='1') { ?> target="_blank"<?php } ?>><span class="badge arc_v5">置顶</span><?php  echo $article->Title;  ?></a></h2>
		</header>
