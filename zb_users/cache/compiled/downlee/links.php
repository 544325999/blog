<?php  /* Template Name:单页友链模板 * Template Type:links */  ?><?php  include $this->GetTemplate('header');  ?>
		...
		<article class="article-main theme-box">
			...
			<div class="article-content">
				<div class="single-entry">
					...
					<div id="linkcat-1" class="linkcat"><h2><?php  echo $modules['link']->Name;  ?></h2>
						<ul class="xoxo blogroll">
							<?php  if(isset($modules['link'])){echo $modules['link']->Content;}  ?>
						</ul>
					</div>
					<div id="linkcat-2" class="linkcat"><h2><?php  echo $modules['misc']->Name;  ?></h2>
						<ul class="xoxo blogroll">
							<?php  if(isset($modules['misc'])){echo $modules['misc']->Content;}  ?>
						</ul>
					</div>
				</div>
