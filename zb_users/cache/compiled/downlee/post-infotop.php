...
<article class="info-list auto-list<?php if ($zbp->Config('downlee')->gdtxoff=='1') { ?> wow fadeInDown" data-wow-delay="0.25s<?php } ?>">
	...
	<div class="sl-main">
		...
		<div class="sl-info"><?php  echo $intro;  ?></div>
	</div>
