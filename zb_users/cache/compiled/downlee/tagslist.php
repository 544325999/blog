<?php  /* Template Name:标签聚合单页 * Template Type:tagslist */  ?><?php  include $this->GetTemplate('header');  ?>
...
<main class="main-content auto-wrap container clearfix">
	<div class="content-wrap fl">
		<article class="article-main theme-box tags-box">
			...
			<div class="article-content">
				<div class="single-entry">
					...
					<div id="tagslist" class="linkcat">
						<h2><?php  echo $article->Title;  ?></h2>
						<ul class="tag_could"><?php  $tags = $zbp->GetTagList('*',null,array('tag_Count'=>'DESC'));  ?><?php  foreach ( $tags as $tag) { ?>
							<li><a href="<?php  echo $tag->Url;  ?>" title="关于[<?php  echo $tag->Name;  ?>]的文章共有<?php  echo $tag->Count;  ?>篇"><span><?php  echo $tag->Name;  ?></span><em>共<?php  echo $tag->Count;  ?>篇文章</em></a></li><?php }   ?>
						</ul>
					</div>
				</div>
				...
				<footer class="article-foot clearfix">
					<?php if ($zbp->Config('downlee')->shareoff=='1') { ?><div class="xshare fl"><span class="xshare-title">分享到：</span><a class="x-weixin" href="javascript:;"><i class="icon font-weixin"></i><img alt="微信" src="<?php  echo $host;  ?>zb_users/theme/downlee/plugin/api.php?url=<?php  echo $article->Url;  ?>"></a><a class="x-qq" href="javascript:Share('tqq')"><i class="icon font-qq"></i></a><a class="x-weibo" href="javascript:Share('sina')"><i class="icon font-weibo"></i></a></div><?php } ?>
