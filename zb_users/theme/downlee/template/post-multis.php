...
<article class="item-body item-mode{if $zbp->Config('downlee')->gdtxoff=='1'} wow fadeInDown{/if}" id="post-{$i}">
	...
	<div class="item-wrapper">
		...
		<div class="item-footer">
			<a href="{$article.Url}"{if $zbp->Config('downlee')->blankoff=='1'} target="_blank"{/if}>
				...
				<span class="item-font-eye"><i class="icon font-eye"></i>{$article.ViewNums}</span>
