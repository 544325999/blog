...
<head>
    ...
    {if $zbp->Config('downlee')->gdtxoff=='1'}<link rel="stylesheet" href="{$host}zb_users/theme/{$theme}/style/libs/animate.css" type="text/css" media="all" />
    {/if}<link href="{$host}zb_users/theme/{$theme}/style/{$style}.css?v={$zbp->themeinfo['modified']}" type="text/css" media="all" rel="stylesheet" />
...
<body class="home home-404{if GetVars('night','COOKIE') } night{/if}{if GetVars('sidehide','COOKIE') } sidehide{/if}" style="background-image:url({$zbp->Config('downlee')->bodybg});">
<div id="pjax_on">
